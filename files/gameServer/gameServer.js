...
export class GameServer {
    ...
    SendToRuntime(message, transmissionMode = "o", forPlayer = null, transferList) {
    ...
    CheckProjectileCollision(projectile) {
        ...
        this.#collisionGrid.ForEachItemInArea(x, y, x, y, (unitPlatform) => {
