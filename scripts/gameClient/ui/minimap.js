...
export class Minimap {
    ...
    #DrawFastUpdateCanvas() {
        ...
        this.#FillRect(this.#fastInst, scrollX - viewWidth / 2, scrollY - viewHeight / 2, viewWidth, viewHeight, [1, 1, 0, 0.05]);
        this.#OutlineRect(this.#fastInst, scrollX - viewWidth / 2, scrollY - viewHeight / 2, viewWidth, viewHeight, [1, 1, 0, 1], 1);
    }
