...
export class ViewManager {
    ...
    ScrollTo(x, y) {
        ...
        this.GetRuntime().layout.scrollTo(MathUtils.Clamp(x, hbound, layoutWidth - hbound), MathUtils.Clamp(y, vbound, layoutHeight - vbound));
    }
    ...
    #SetActualZoom(z, force = false) {
        ...
        this.ScrollTo(layout.scrollX + dx * zoomFactor, layout.scrollY + dy * zoomFactor);
